...
def input_face(camera, display=True, is_face_detection=True, is_face_mesh=False, title="请选择需要检测的人脸") :
    '''
    输入人脸
    ...
    [return] (width, height)
    '''
    imgpath = open_camera(display, is_face_detection, is_face_mesh) \
                if camera else \
